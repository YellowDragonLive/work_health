...
### Bonus: Deep Reflection Questions (Supplemental)

To further your progress, here are additional questions to use during your excavation phases:

**On Identity & Social Pressure:**
- What character are you playing in other people's stories, and does that role conflict with your own mission? (你在别人的故事里扮演什么角色？这个角色是否与你的使命冲突？)
- If you were to lose your current social status tomorrow, what parts of your life would you actually miss, and what would you feel relieved to let go of? (如果你明天失去了现有的社会地位，你会真正怀念哪些部分？又会因为放下哪些而感到解脱？)

**On Focus & Procrastination:**
- Is the problem you’re trying to solve a real blockage, or a distraction you’ve created to "feel useful" without making actual progress? (你试图解决的问题是真正的障碍，还是你为了让自己看起来“有用”而创造的借口？)
- If you were forbidden from working for more than 2 hours a day, which single task would you execute to ensure your long-term success? Why aren't you doing *only* that? (如果你每天被禁止工作超过两小时，你会执行哪一项任务来确保长期的成功？为什么你现在没有只做那一件事？)

**On Entropy & Systems:**
- Where did you fail to uphold your own principles today, and what specific emotional trigger caused the collapse? (今天你在哪里没能坚持自己的原则？是什么具体的情绪触发了这次崩塌？)
- If your life is a feedback loop, what is the one "input" you repeatedly allow that consistently produces a "low-quality output"? (如果你的生活是一个反馈循环，你重复允许的哪一个“输入”持续产生了“低质量的输出”？)

**On Perspective & Meaning:**
- If you had to live this exact day again for the next 100 days, would it be a heaven of progress or a hell of stagnation? (如果你必须在接下来的 100 天内重复过这完全相同的一天，这会是进步的天堂还是停滞的地狱？)
- What is the most obvious truth about your life that you are currently putting the most energy into avoiding? (关于你的生活，你目前正投入最大精力去逃避的、最显而易见的真相是什么？)
...
Type your email...
Subscribe
© 2026 DAN KOE · Privacy ∙ Terms ∙ Collection notice
Start your Substack
Get the app
